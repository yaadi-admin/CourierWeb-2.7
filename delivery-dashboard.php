    ...
    <div class="wrapper">
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftnavset">
            ...
            <li class="bold"><a href="delivery-dashboard.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Dashboard</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>All Deliveries</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-deliveries.php">All Deliveries</a>
                                </li>
								<?php
            ...
            <li class="bold"><a href="#." class="waves-effect waves-cyan"><i class="mdi-social-person"></i>Reports</a>
            </li>
        </ul>
      ...
      <section id="content">
        <div id="breadcrumbs-wrapper">
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Deliveries</h5>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container">
              <p class="caption">
                  <b>What's new</b>
              <blockquote style="border-radius:16px;">These are <b>all the orders</b> update the order status <b>if not completed</b></blockquote></p>
              <a href="#footershow" style="color: white;"><button class="btn waves-effect waves-light right submit" type="submit" name="action" style="border-radius:16px;">Go to last Order<i class="mdi-content-clear right"></i>
              </button></a><br />
