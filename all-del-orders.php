    ...
    <div class="wrapper">
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftnavset">
            ...
            <li class="bold"><a href="#." class="waves-effect waves-cyan"><i class="mdi-social-person"></i>Reports <span class="badge" data-badge-caption="Beta"><h6 style="font-size:10px;">Coming Soon</h6></span></a>
            </li>				
        </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Status Orders</h5>
              </div>
            </div>
          </div>
        </div>
