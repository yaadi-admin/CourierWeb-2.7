...
<head>
  ...
  <title>YAADI™ | Customer Account</title>
  ...
  <div id="main">
    <div class="wrapper">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12" style="background-image: url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/38816/image-from-rawpixel-id-594540-png.png), url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/38816/paperboard-texture_95678-72.jpg);border-radius: 16px;">
                <h5 class="breadcrumbs-title">Customer Account</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <p class="caption">Edit customer account details below. Details are required for delivery and Communication.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header"><?php echo $name;?></h4>
                  
                  <form class="formValidate" id="formValidate1" method="post" action="routers/verified-router.php?phone=<?php echo $contact; ?>" novalidate="novalidate">
                    
                    <button class="btn cyan waves-effect waves-light left" type="submit" name="action">Verified
                                <i class="mdi-content-send right"></i>
                              </button></form>
                    
                    <form class="formValidate" id="formValidate1" method="post" action="routers/locnotify-router.php?phone=<?php echo $contact; ?>" novalidate="novalidate">
                    
                    <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Send L.O.C
                               <i class="mdi-content-send right"></i>
                              </button></form>
                  <br /><br />
