...
if($_SESSION['admin_sid']==session_id())
{
    ...
    $count = 0;
    $result = mysqli_query($con, "SELECT * FROM timeline WHERE user_id='$id';");
    while($row = mysqli_fetch_array($result))
    {
        $count++;
    }
        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftnavset">
                    ...
                    <li class="active bold"><a href="am_active.php" class="waves-effect waves-cyan"><i class="mdi-action-book"></i>My Activity</a>
                    </li>
                </ul>
                    ...
                    <div id="editableTable" class="section">
                        <div class="row">
                            <ul class="collection with-header collapsible z-depth-0">
                                <li class="collection-header"><h4>My Activity <span class="right"><?php echo $count; ?><span style="font-size: 10px;"> interactions</span></span></h4><p class="caption">This is your time lined activity list, a thorough list of your actions and changes are stated below.</p></li>
