    ...
    <div id="main">
        <div class="wrapper">
            ...
            <section id="content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <h5 class="breadcrumbs-title">Post to Yaadi
                                </h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <p class="caption">Post picture Ads to Yaadi.Co</p>
                    <p class="caption center"> Post to Yaadi</p>
                    <form action="routers/upload.php?" method="post" enctype="multipart/form-data">
