        ...
        <div class="wrapper">
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftnavset" style="border-top-right-radius: 8px;">
                    ...
                    <li class="active bold"><a href="delivery-history.php" class="waves-effect waves-cyan"><i class="mdi-action-book"></i>History</a>
                    </li>
            ...
            <section id="content">
                ...
                <div>
                    ...
                    ';
                        ...
                        if ($count == 0){
                            echo '<h5 class="center">No past orders</h5>';
                        }
