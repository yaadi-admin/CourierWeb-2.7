...
if($_SESSION['admin_sid']==session_id()) {
    if (isset($_POST['reopen'])) {
        ...
        $subject = 'Order # '.$item_id.' reopened';
        $message = '
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Order #'.$item_id.' reopened</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h1>Order Updated</h1>
                        <h2>Order #'.$item_id.' was reopened by an admin</h2>
...
';
        ...
        header("location: ../all-orders.php?status=$valtwo");
    } else {
        echo '<script>Materialize.toast("Item could not be reopened", 8000);</script>';
    }
}
?>