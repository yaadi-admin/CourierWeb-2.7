...
if($continue){
    ...
    <div id="main">
        <div class="wrapper">
            ...
            <section id="content">
                ...
                <div class="container">
                    <p class="caption">Confirm your order details before placing the order.</p>
		...
		<p><strong>Payment Typeee: </strong>'.htmlspecialchars($_POST['pay_type']).'</p>
    ...
    <div class="row">
            <div class="col s6">
                <p class="collections-title"><strong>™ </strong>Delivery Fee</p>
            </div>
            <div class="col s2">
                <span>Est.</span>
            </div>
