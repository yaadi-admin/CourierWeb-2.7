...
if($_SESSION['delivery_sid']==session_id()) {
    ...
    if (isset($_POST['del_assign'])) {
        ...
        $sql = "UPDATE hanker_orders SET assignedto = '$user_id' WHERE id = $assign ;";
        $con->query($sql);

        $to = 'yaadiltd@gmail.com';
        $subject = 'Order '.$assign.' was assigned to the courier';
        $message = '
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Order #'.$assign.' was assigned to the courier</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h2>Order #'.$assign.' was assigned by the courier</h2>
